...
public class CompanyRepresentativeMenu extends BaseMenu {
    ...
    private void viewApplications() {
        CompanyRepresentative rep = (CompanyRepresentative) currentUser;
        CompanyRepresentativeMenu2.viewApplications(systemManager, rep);
        pauseForUser();
    }
    ...
    private void manageApplications() {
        CompanyRepresentative rep = (CompanyRepresentative) currentUser;
        CompanyRepresentativeMenu2.manageApplications(systemManager, rep, scanner);
    }
    ...
    private void toggleInternshipVisibility() {
        CompanyRepresentative rep = (CompanyRepresentative) currentUser;
        CompanyRepresentativeMenu2.toggleInternshipVisibility(systemManager, rep, scanner);
    }
}